  ...
  products.forEach((prd) =>{
    ...
    strc+=`     <div class="col-3 mt-3">
                        <div class="card" style="width: 18rem;">
                            <img src="${prd.thumbnail}" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title text-secondary title-font fs-5">${prd.title}</h5>
                            </div>
                            <p class="ms-3">$${prd.price}</p>
                          <div class=" ms-3">
                          ...
                          <div class="card-body">
                               <button type="button" class="btn btn-primary" onclick="addcart(${prd.id})">add to cart</button>
                               <button type="button" class="btn btn-secondary">buy now</button>
                            </div>
                            <div>
                            <span class="badge rounded-pill bg-success ms-3 mb-1">
                            <i class="bi bi-star-fill"></i> ${prd.rating}<img src="./images/image-removebg-preview (17).png" alt="star" style="width:10px; height:10px;">
                            </span>
                            </div>
                        </div>
                    </div>`;
